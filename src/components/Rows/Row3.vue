<template>
  <div class="text-center" style="width:100%;">
    <button class="chart-button" v-show="toggleButton" @click="toggle = !toggle, toggleButton = !toggleButton">View Chart</button>
...
export default {
  ...
  methods: {
    getWindowWidth() {
	  ...
	  this.windowWidth > 500 ? (this.toggle = true , this.toggleButton = false) : (this.toggle = false , this.toggleButton = true)
    },
    getWindowHeight() {
