  ...
  <div class="col-md-8 bg-w">
     ...
     <div class='row no-border'>
         <div class="col-md col-medium">
             <div class='focal-text'>37,243</div>
    ...
    <div class="col-md-4 p-0" style='border-left: 40px solid ##FAF9F5;'>
      <div class='row row-small px-0 py-4 bg-w ml-5 m-0' style='border-top-left-radius: 10px; border-top-right-radius: 10px;'> 
          <div class='col-md-6 m-auto'>
              ...
              <div class='convert-txt'><img src='../../assets/images/fill-37.png' class="align-baseline pr-1"/> 12.8%</div>
          </div>  
          <div class='col-md-6 right pr-4'>
            <span class='lg-num-blk'>76,452</span>
          </div>
      </div>
      <div class='row row-small px-0 py-4 bg-w ml-5 my-1 mr-0'> 
          <div class='col-md-6 m-auto'>
              <div class='mid-txt'>Conversions</div>
              <div class='convert-txt'><img src='../../assets/images/fill-37.png' class="align-baseline pr-1" />2.5%</div>
          </div>  
          <div class='col-md-6 right pr-4'>
              <span class='lg-num-blk'>256</span>
          </div>
      </div>
      <div class='row row-small px-0 py-4 bg-w ml-5 my-1 mr-0' style='border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;'> 
          ...
          <div class='col-md-6 right pr-4'>
              <span class='lg-num-blk'>0.42%</span>
          </div>
      </div>
